...
icamp_discrete <- pal_palette(
  ...
  fluro = c("#FF0000", "#00FF00", "#0000FF", "#F7941D"),

  colorblind_friendly = c("#000000","#51B4E5", "#D36027", "#999999", "#E5A024", "#009E73", "#F0E442", "#0073B2")

)

plot(icamp_palettes_discrete)

usethis::use_data(icamp_palettes_discrete, overwrite = TRUE)
