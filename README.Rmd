...
Finally, icampcolors can be used with non-ggplot data visualization tools in R. Here is an example of a graph displaying Ozone levels from the 'airquality' dataset using the bright color palette: 


```{r echo = TRUE}

#create plot
plot(airquality$Ozone, type = "b", col = icamp_color_palettes$bright[6], lwd = 2, xlab = "Day", ylab = "Ozone Level", main = "Ozone Levels Over Time")
